...
return [
    'shop' => [
        'subscription' => [
            ...
            'not-authorized'      => 'Avertissement: Vous n\'êtes pas autorisé à effectuer cette action.',
            'not-found'           => 'Avertissement: Aucun abonnement trouvé.',
    ...
    'admin' => [
        ...
        'configuration' => [
            'custom-scripts' => [
                'update-success' => 'Succès : Les scripts personnalisés ont été mis à jour avec succès.',
            ],
        ],
