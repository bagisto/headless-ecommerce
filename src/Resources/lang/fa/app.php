...
return [
    'shop' => [
        'subscription' => [
            ...
            'not-authorized'      => 'هشدار: شما مجاز به انجام این عمل نیستید.',
            'not-found'           => 'هشدار: هیچ اشتراکی یافت نشد.',
        ...
        'customers' => [
            ...
            'account' => [
                ...
                'wishlist' => [
                    ...
                    'moved-success'   => 'موفقیت: آیتم های انتخاب شده با موفقیت به لیست علاقه مندی ها منتقل شدند.',
                ],
