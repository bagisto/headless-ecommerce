...
return [
    'shop' => [
        'subscription' => [
            'already'             => 'आप पहले से ही हमारे न्यूजलेटर की सदस्यता ले चुके हैं।',
            'not-authorized'      => 'चेतावनी: आपको इस कार्रवाई को करने की अनुमति नहीं है।',
            'not-found'           => 'चेतावनी: कोई सदस्यता नहीं मिली।',
            'subscribe-success'   => 'आपने हमारे न्यूजलेटर की सदस्यता सफलतापूर्वक ली है।',
            'unsubscribe-success' => 'आपने हमारे न्यूजलेटर की सदस्यता सफलतापूर्वक रद्द कर दी है।',
        ],
